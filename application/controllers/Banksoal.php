...
class Banksoal extends MY_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('M_BankSoal', 'M_Mapel', 'M_Kelas', 'M_Guru', 'M_GudangSoal', 'M_OcrSoal'));
    }
...
4\tD\tSuasana gembira";
    ...
    /**
     * AJAX Endpoint: Upload Gambar Materi / Foto Kamera & Ekstraksi Teks OCR
     */
    ...
    /**
     * AJAX Endpoint: Merangkum Teks OCR Menjadi Kesimpulan & Konsep Kunci
     */
    ...
    /**
     * AJAX Endpoint: Generate Butir Soal Berdasarkan Summary & Materi OCR
     */
    ...
    /**
     * AJAX Endpoint: Simpan Soal Hasil OCR & AI ke Repositori Bank Soal
     */
