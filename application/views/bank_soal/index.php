                ...
                <?php else: ?>
                  <?php foreach ($bank_list as $b): ?>
                    <tr>
                      ...
                      <td class="text-end">
                        <a href="<?= base_url('banksoal/export_word/' . encrypt_id($b['id'])) ?>" class="btn btn-sm btn-outline-info me-1 fw-bold" title="Export to Word (.doc)">
                          <i class="bi bi-file-earmark-word-fill me-1"></i> Word
                        </a>
                        <a href="<?= base_url('banksoal/detail/' . encrypt_id($b['id'])) ?>" class="btn btn-sm btn-outline-primary fw-bold">
