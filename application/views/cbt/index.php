              ...
              <div class="card h-100 shadow-sm border-0 rounded-4">
                ...
                <div class="card-body">
                  ...
                  <?php if ($u['status_peserta'] === 'Selesai'): ?>
                    ...
                    <a href="<?= base_url('cbt/ulangi_ujian/' . encrypt_id($u['id'])) ?>" onclick="return confirm('Ulangi pengerjaan ujian ini? Jawaban pengerjaan sebelumnya akan di-reset.')" class="btn btn-outline-warning btn-sm w-100 fw-bold">
                      <i class="bi bi-arrow-repeat me-1"></i> Ulangi Pengerjaan Ujian (Remidi)
                    </a>
                  <?php else: ?>
                    <a href="<?= base_url('cbt/konfirmasi/' . encrypt_id($u['id'])) ?>" class="btn btn-primary w-100 fw-bold py-2 shadow-sm">
